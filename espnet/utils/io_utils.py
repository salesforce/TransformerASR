...
# Weiran: I am introducing transformation probability.
from espnet.transform.transformation import Transformation_with_prob
...
class LoadInputsAndTargets(object):
    ...
    def __init__(self, mode='asr',
        ...
        if preprocess_conf is not None:
            # Weiran: I changed transformation to use probability.
            # self.preprocessing = Transformation(preprocess_conf, preprocess_prob)
            self.preprocessing = Transformation_with_prob(preprocess_prob, preprocess_conf)
            logging.warning(
    ...
    def _create_batch_asr(self, x_feats_dict, y_feats_dict, uttid_list):
        ...
        # Weiran: remove empty inputs.
        # nonzero_idx = list(filter(lambda i: len(xs[0][i]) > 0, nonzero_idx))
