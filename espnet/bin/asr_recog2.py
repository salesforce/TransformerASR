...
def get_parser():
    ...
    parser.add_argument('--model1-conf', type=str, default=None,
    ...
    parser.add_argument('--model2', type=str, required=True,
                        help='Model file parameters to read')
    parser.add_argument('--model2-conf', type=str, default=None,
                        help='Model config file')
    ...
    # rnnlm related
    parser.add_argument('--rnnlm1', type=str, default=None,
                        help='RNNLM model file to read')
    parser.add_argument('--rnnlm1-conf', type=str, default=None,
                        help='RNNLM model config file to read')
    parser.add_argument('--lexicon1-dict', type=str, default=None,
                        help='Lexicon dict to read')

    parser.add_argument('--rnnlm2', type=str, default=None,
                        help='RNNLM model file to read')
    parser.add_argument('--rnnlm2-conf', type=str, default=None,
                        help='RNNLM model config file to read')
    parser.add_argument('--lexicon2-dict', type=str, default=None,
                        help='Lexicon dict to read')
    parser.add_argument('--model2-weight', type=float, default=0.5,
                        help='weight for score from model2')
...
def main(args):
    ...
    if args.rnnlm1 is not None and args.rnnlm2 is not None and args.word_rnnlm is not None:
        logging.warning("Both --rnnlm and --word-rnnlm are specified, using multi-level RNNLM.")

    # recog
    from espnet.asr.pytorch_backend.asr_dsl import recog_with_two_models
    recog_with_two_models(args)
